...
def run():
    ...
    for episode in t:
        ...
        t.set_description(f"Reward: {total_rewards:.2f} - Avg: {avg:.2f}")
        
        #train
        if len(replay_memory) > batch_size+1 and episode % train_interval == 0:
            ...
            # training_step_no_critic_no_target(
            #     batch,
            #     actor_model,
            #     optimizer,
            #     n_outputs,
