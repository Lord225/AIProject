...
def run_episode(
    ...
    max_steps: int,
    history: Tuple[tf.TensorArray, tf.TensorArray, tf.TensorArray, tf.TensorArray],
    history_index: int,
    history_size: int,
    ) -> Tuple[Tuple[tf.TensorArray, tf.TensorArray, tf.TensorArray, tf.TensorArray], int]:
    ...
    states = states.stack().mark_used()
    action_probs = action_probs.stack().mark_used()
    values = values.stack().mark_used()
    rewards = rewards.stack().mark_used()
